  ...
  return (
    <div className='w-full h-full flex justify-center'>
      <div className='w-11/12 h-full lg:w-2/4'>
        <div className=" pl-2 h-[10%] flex justify-between items-center">
        ...
        <div className='h-[90%] relative p-5 lg:p-9 border border-slate-800'>
            ...
            {messages.map(message => (
              <div key={message.$id} className=''>
                <div className='flex justify-between pl-1'>
                  ...
                  <span className='text-slate-400 text-xs p-1'>
                    {new Date(message.$createdAt).toLocaleString()}
                  </span>
                </div>
                <div className='mb-2 gap-2 flex justify-between'>
                  <span
                    className={`px-2 lg:px-3.5 p-2 lg:p-2.5 rounded-2xl text-xl 
          ...
          <form onSubmit={handleSubmit}>
            <div className="flex absolute bottom-0 left-0 px-5 lg:px-8 pt-2 pb-5 gap-1 w-full">
              <input
